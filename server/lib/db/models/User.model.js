...
_get__('Model').extend(_get__('User'));

_get__('User').tableName = 'Users';

_get__('User').jsonSchema = {
  type: 'object',
  properties: {
    id: { type: 'integer' },
    name: { type: 'string' }
...
var _typeOfOriginalExport = typeof User === 'undefined' ? 'undefined' : (0, _typeof3.default)(User);

function addNonEnumerableProperty(name, value) {
  (0, _defineProperty2.default)(User, name, {
    value: value,
    enumerable: false,
    configurable: true
  });
...
if ((_typeOfOriginalExport === 'object' || _typeOfOriginalExport === 'function') && (0, _isExtensible2.default)(User)) {
